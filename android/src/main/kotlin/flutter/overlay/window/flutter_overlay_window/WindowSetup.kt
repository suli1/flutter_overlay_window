...
object WindowSetup {
    ...
    fun setNotificationVisibility(name: String) {
        ...
        } else if (name.equals("visibilitySecret", ignoreCase = true)) {
            notificationVisibility = NotificationCompat.VISIBILITY_SECRET
        } else if (name.equals("visibilityPrivate", ignoreCase = true)) {
    ...
    fun setFlag(name: String) {
        ...
        } else if (name.equals("flagNotTouchable", ignoreCase = true) || name.equals(
                "clickThrough",
                ignoreCase = true
            )
        ) {
        ...
        } else if (name.equals("flagNotTouchModal", ignoreCase = true) || name.equals(
                "focusPointer",
                ignoreCase = true
            )
        ) {
